...
import cn.ykchen.platform.modules.bus.service.PurchaseOrderService;
 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/bus/purchaseOrder")
public class PurchaseOrderController extends BaseController {
	...
	@RequiresPermissions("bus:purchaseOrder:view")
	...
	public String list(PurchaseOrder purchaseOrder, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		return "modules/bus/purchaseOrderList";
	}
	...
	public String form(PurchaseOrder purchaseOrder, Model model) {
		...
		return "modules/bus/purchaseOrderForm";
	}

	@RequiresPermissions("bus:purchaseOrder:edit")
	...
	public String save(PurchaseOrder purchaseOrder, Model model, RedirectAttributes redirectAttributes) {
		...
		return "redirect:"+Global.getAdminPath()+"/bus/purchaseOrder/?repage";
	}

	@RequiresPermissions("bus:purchaseOrder:edit")
	@RequestMapping(value = "goOnSave")
	public String goOnSave(PurchaseOrder purchaseOrder, Model model, RedirectAttributes redirectAttributes) {
		if (!beanValidator(model, purchaseOrder)){
			return form(purchaseOrder, model);
		}
		purchaseOrderService.save(purchaseOrder);
		addMessage(redirectAttributes, "保存采购订单成功");
		return "redirect:"+Global.getAdminPath()+"/bus/purchaseOrder/form";
	}
